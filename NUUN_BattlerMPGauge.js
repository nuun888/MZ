...
Sprite_Actor.prototype.setMpGaugePosition = function() {
    if (this._battler.isEnemy()) {
        ...
        this._butlerMP.x = x;
        this._butlerMP.y = y - this.getButlerMpSVPosition();
    }
};

Sprite_Battler.prototype.getButlerMpPosition = function() {
...
Sprite_Actor.prototype.getButlerMpSVPosition = function() {
...
Sprite_EnemyMPGauge.prototype.isHPLabelVisible = function() {
    return MPLabelVisible;
};

Sprite_EnemyMPGauge.prototype.isHPValueVisible = function() {
    return MPValueVisible;
};

Sprite_EnemyMPGauge.prototype.getHPVisible = function() {
    return MPVisible;
};
