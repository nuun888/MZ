/*:-----------------------------------------------------------------------------------
 * NUUN_ContinuationItemCommonEvent.js
 * 
...
Imported.NUUN_ContinuationItemCommonEvent = true;

(() => {
    const parameters = PluginManager.parameters('NUUN_ContinuationItemCommonEvent');
