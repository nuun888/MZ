 ...
 * 
 * Settings for each item are set in the equipment status page settings.
 * 
 ...
 * 
 * @param EquipContentsList
 * @desc Set the items to be displayed in the equipment status.
 * @text Equipment status item settings
...
(() => {
    ...
    Window_EquipStatus.prototype.getPageList = function() {
        return EquipPageList[this.getPage()].EquipContentsList;
    };
