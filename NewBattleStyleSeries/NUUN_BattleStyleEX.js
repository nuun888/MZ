 ...
 * The method for the actor name item on the actor status screen has been corrected to the method name for dynamic display.
 ...
 * @value Name
 * @option Actor face(1)(2)(3)(4)(h)
 * @value Face
 * @option Actor name(1)(2)(3)(4)(5)(9)(11)(12)(21)(h)
 * @value DynamicName
 ...
 * 
 * @param GaugeHeight
 * @desc Specifies the vertical height of the gauge and actor name.
 * @text Gauge, Actor, Name height(21)
 * @type number
 * @default 0
 * @min 0
 * @max 99
 ...
 * @value Name
 * @option 顔グラフィック(1)(2)(3)(4)(h)
 * @value Face
 * @option アクター名(1)(2)(3)(4)(5)(9)(11)(12)(21)(h)
 * @value DynamicName
 ...
 * 
 * @param GaugeHeight
 * @desc ゲージ、アクター名の縦幅を指定します。
 * @text ゲージ、アクタ、名の縦幅(21)
 * @type number
 * @default 0
 * @min 0
 * @max 99
...
(() => {
    ...
    Window_BattleActorStatus.prototype.show = function() {
        Window_Base.prototype.show.apply(this, arguments);
    };
