...
[ダウンロード](https://raw.githubusercontent.com/nuun888/MZ/master/NewBattleStyleSeries/NUUN_BattleItemSkillWindowEX.js)Ver.1.0.2   
### 戦闘中メッセージウィンドウ背景画像
...
フロントビューで味方のエフェクトを表示する場合、一部のアニメーションの表示がおかしいと言うお問い合わせはこちらでは対処できませんので、ウィンドウ表示モードを'Sprite'モードに選択していただくか
...
英語表示のアクターステータス画面のアクター名の項目メソッドが動的表示のメソッド名に修正。  
