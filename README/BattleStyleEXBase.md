...
## 設定用プラグイン
[バトルスタイル拡張デフォルト設定用](https://raw.githubusercontent.com/nuun888/MZ/master/NUUN_BattleStyleEX_Default.js)Ver.1.9.1  
[バトルスタイル拡張スタンダード設定用](https://raw.githubusercontent.com/nuun888/MZ/master/NUUN_BattleStyleEX_Standard.js)Ver.1.9.1  
[バトルスタイル拡張XPスタイル設定用](https://raw.githubusercontent.com/nuun888/MZ/master/NUUN_BattleStyleEX_XP.js)Ver.1.9.1  
[バトルスタイル拡張タイプ4設定用](https://raw.githubusercontent.com/nuun888/MZ/master/NUUN_BattleStyleEX_Type4.js)Ver.1.2.1

バトルスタイル拡張デフォルト設定用 Ver.1.9.1  
![画像](img/BattleStyleEX1.png)  

バトルスタイル拡張スタンダード設定用 Ver.1.9.1 
![画像](img/BattleStyleEX2.png)  

バトルスタイル拡張XPスタイル設定用 Ver.1.9.1  
![画像](img/BattleStyleEX3.png)  

バトルスタイル拡張タイプ4設定用 Ver.1.2.1  
