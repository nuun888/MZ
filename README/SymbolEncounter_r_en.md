# Symbol Encounter
## Ver.1.1.2
#### Required and prerequisite plugins
[NUUN_Base](https://github.com/nuun888/MZ/blob/master/README/Base.md)  
...
フォロワーすり抜けはノーマルイベントモードの時には実行されません。  
